...
# traces_wt = {"EXC": {"Amp 2µm": [], "Amp 4µm": [], "Amp 6µm": [], "Amp 8µm": [], "Amp 10µm": [], "Amp 12µm": [], "Reward event": [], "Timeout event": []},
#              "INH": {"Amp 2µm": [], "Amp 4µm": [], "Amp 6µm": [], "Amp 8µm": [], "Amp 10µm": [], "Amp 12µm": [], "Reward event": [], "Timeout event": []}}
# traces_ko = {"EXC": {"Amp 2µm": [], "Amp 4µm": [], "Amp 6µm": [], "Amp 8µm": [], "Amp 10µm": [], "Amp 12µm": [], "Reward event": [], "Timeout event": []},
#              "INH": {"Amp 2µm": [], "Amp 4µm": [], "Amp 6µm": [], "Amp 8µm": [], "Amp 10µm": [], "Amp 12µm": [], "Reward event": [], "Timeout event": []}}
...
#
#         for timings, name in zip(events_timings, ["Amp 2µm", "Amp 4µm", "Amp 6µm", "Amp 8µm", "Amp 10µm", "Amp 12µm", "Reward event", "Timeout event"]):
...
#
#
# dn_ex_wt, dn_in_wt = cluster_heatmap(np.concatenate(traces_wt['EXC']["Amp 12µm"]), np.concatenate(traces_wt['INH']["Amp 12µm"]))
# dn_ex_ko, dn_in_ko = cluster_heatmap(np.concatenate(traces_ko['EXC']["Amp 12µm"]), np.concatenate(traces_ko['INH']["Amp 12µm"]))
...
roi_info = pd.read_excel(directory + "/FmKO_ROIs&inhibitory.xlsx")
files = ["20220728_4456_02_synchro"]
for folder in files:
    if os.path.isdir(directory + folder):
        path = directory + folder + '/'
        # recording = pc.RecordingAmplDet(path, 0, folder, roi_info)
