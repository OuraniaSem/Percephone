...
cebra_model = cebra.CEBRA(
    ...
    max_adapt_iterations=200, #to change to ~100-500
    time_offsets=10,
    output_dimension=8,
    verbose=False
)
...
# 2. Load example data
neural_data = get_zscore(rec, exc_neurons=True, inh_neurons=False, time_span="stim", window=0.5, estimator="Mean", sort=False, amp_sort=False, single_frame_estimator=True)
